...
build_deb() {
    ...
    if [[ "$CURRENT_VERSION" != "$VERSION" ]] ; then
      ...
      sed -i "1s_^_  * More info: https://documentation.wazuh.com/current/release-notes/\n\n_" SPECS/$VERSION/wazuh-manager/debian/changelog
      ...
      sed -i "1s_^_  * More info: https://documentation.wazuh.com/current/release-notes/\n\n_" SPECS/$VERSION/wazuh-agent/debian/changelog
      ...
      sed -i "1s_^_  * More info: https://documentation.wazuh.com/current/release-notes/\n\n_" SPECS/$VERSION/wazuh-api/debian/changelog
