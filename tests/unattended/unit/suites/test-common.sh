...
test-05-common_checkInstalled-all-installed-yum() {
    ...
    @mock grep wazuh-manager === @echo wazuh-manager.x86_64  4.3.3-1 @wazuh
    @mkdir /var/ossec
...
test-05-common_checkInstalled-all-installed-yum-assert() {
    @echo "wazuh-manager.x86_64 4.3.3-1 @wazuh"
    @echo 1
...
test-06-common_checkInstalled-all-installed-zypper() {
    ...
    @mock grep wazuh-manager === @echo "i+ | EL-20211102 - Wazuh | wazuh-manager | 4.3.3-1 | x86_64"
    @mkdir /var/ossec
...
test-06-common_checkInstalled-all-installed-zypper-assert() {
    @echo "i+ | EL-20211102 - Wazuh | wazuh-manager | 4.3.3-1 | x86_64"
    @echo 1
