...
installFilebeat() {
    ...
    if [ "$?" != 0 ]; then
        ...
        curl -so /etc/filebeat/wazuh-template.json https://raw.githubusercontent.com/wazuh/wazuh/v4.1.5/extensions/elasticsearch/7.x/wazuh-template.json --max-time 300
