...
${rpm_url}/libstdc++-devel-4.8.5-39.el7.armv7hl.rpm \
${rpm_url}/libstdc++-4.8.5-39.el7.armv7hl.rpm \
...
https://armv7.dev.centos.org/repodir/epel-pass-1/libuv/1.37.0-1.el7/armv7hl/libuv-1.37.0-1.el7.armv7hl.rpm \
