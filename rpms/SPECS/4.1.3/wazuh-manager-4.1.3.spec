...
# Download filebeat.service file
curl -so filebeat.service https://packages-dev.wazuh.com/deps/filebeat-test/filebeat.service
...
%attr (644, root, root) /usr/lib/systemd/system/filebeat.service
