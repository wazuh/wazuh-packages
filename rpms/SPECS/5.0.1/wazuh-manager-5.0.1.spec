...
%config(noreplace) %attr(600, root, root) %{_localstatedir}/filebeat/etc/certs/filebeat.key
%config(noreplace) %attr(644, root, root) %{_localstatedir}/filebeat/etc/certs/filebeat.pem
%config(noreplace) %attr(644, root, root) %{_localstatedir}/filebeat/etc/certs/root-ca.pem
%attr(644, root, root) %{_localstatedir}/filebeat/etc/wazuh-template.json
%config(noreplace) %attr(644, root, root) %{_localstatedir}/filebeat/etc/filebeat.yml
