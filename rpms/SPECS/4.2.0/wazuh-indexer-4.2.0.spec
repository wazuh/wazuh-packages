...
cp files/elasticsearch-oss-extracted-files/etc/init.d/%{SERVICE_NAME} %{buildroot}/etc/init.d/%{SERVICE_NAME}
cp files/elasticsearch-oss-extracted-files/etc/wazuh-indexer/log4j2.properties %{buildroot}%{CONFIG_DIR}/log4j2.properties
cp files/elasticsearch-oss-extracted-files/etc/wazuh-indexer/jvm.options %{buildroot}%{CONFIG_DIR}/jvm.options
cp files/elasticsearch-oss-extracted-files/etc/sysconfig/%{SERVICE_NAME} %{buildroot}/etc/sysconfig/%{SERVICE_NAME}
cp files/elasticsearch-oss-extracted-files/usr/lib/tmpfiles.d/%{SERVICE_NAME}.conf %{buildroot}/usr/lib/tmpfiles.d/%{SERVICE_NAME}.conf
...
cp files/opendistro-performance-analyzer.service %{buildroot}/usr/lib/systemd/system/
