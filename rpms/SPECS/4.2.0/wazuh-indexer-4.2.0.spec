...
curl -o files/config_files/etc/init.d/%{SERVICE_NAME} --create-dirs https://raw.githubusercontent.com/wazuh/wazuh-packages/679-wazuh-indexer/wazuh-indexer/config_files/etc/init.d/%{SERVICE_NAME}
curl -o files/config_files/etc/wazuh-indexer/log4j2.properties --create-dirs https://raw.githubusercontent.com/wazuh/wazuh-packages/679-wazuh-indexer/wazuh-indexer/config_files/etc/wazuh-indexer/log4j2.properties
curl -o files/config_files/etc/wazuh-indexer/jvm.options --create-dirs https://raw.githubusercontent.com/wazuh/wazuh-packages/679-wazuh-indexer/wazuh-indexer/config_files/etc/wazuh-indexer/jvm.options
curl -o files/config_files/etc/sysconfig/%{SERVICE_NAME} --create-dirs https://raw.githubusercontent.com/wazuh/wazuh-packages/679-wazuh-indexer/wazuh-indexer/config_files/etc/sysconfig/%{SERVICE_NAME}
curl -o files/config_files/usr/lib/tmpfiles.d/%{SERVICE_NAME}.conf --create-dirs https://raw.githubusercontent.com/wazuh/wazuh-packages/679-wazuh-indexer/wazuh-indexer/config_files/usr/lib/tmpfiles.d/%{SERVICE_NAME}.conf
curl -o files/config_files/usr/lib/sysctl.d/%{SERVICE_NAME}.conf --create-dirs https://raw.githubusercontent.com/wazuh/wazuh-packages/679-wazuh-indexer/wazuh-indexer/config_files/usr/lib/sysctl.d/%{SERVICE_NAME}.conf
curl -o files/config_files/usr/lib/systemd/system/%{SERVICE_NAME}.service --create-dirs https://raw.githubusercontent.com/wazuh/wazuh-packages/679-wazuh-indexer/wazuh-indexer/config_files/usr/lib/systemd/system/%{SERVICE_NAME}.service
