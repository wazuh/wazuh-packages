...
cp -r ruleset/sca/{applications,generic,centos,darwin,debian,rhel,sles,sunos,windows,nginx,mongodb,oracledb} ${RPM_BUILD_ROOT}%{_localstatedir}/tmp/sca-%{version}-%{release}-tmp
