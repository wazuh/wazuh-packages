...
main() {
    ...
    if [ "${DIST_NAME}" = "centos" ]; then
        package_name="wazuh-agent-4.2.5-0.1.x86_64.rpm"
        wget "https://s3.us-west-1.amazonaws.com/packages-dev.wazuh.com/custom/4.2-rc-rcs-wp/wazuh-agent-4.2.5-0.1.x86_64.rpm"
