...
main() {
    ...
    if [ "${DIST_NAME}" = "centos" ]; then
        package_name="wazuh-agent-4.2.0-0.1.x86_64.rpm"
        wget "https://s3-us-west-1.amazonaws.com/packages-dev.wazuh.com/warehouse/test/4.2/rpm/opt/wazuh-agent-4.2.0-0.1.x86_64.rpm"
