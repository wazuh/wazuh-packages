...
if [ "%{version}" = "99.99.0" ];then
    ...
    runuser %{USER} --shell="/bin/bash" --command="%{buildroot}%{INSTALL_DIR}/bin/opensearch-dashboards-plugin install https://packages-dev.wazuh.com/warehouse/test/4.3/ui/dashboard/wazuh-%{version}-%{release}.zip"
fi
