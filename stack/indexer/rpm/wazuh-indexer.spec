...
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/javadoc
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jmod
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jpackage
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jrunscript
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jhsdb
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jstat
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jdb
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jdeprscan
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/java
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/rmiregistry
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/javac
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jconsole
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jlink
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jfr
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jinfo
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/serialver
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jps
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jcmd
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/javap
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/keytool
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jstatd
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jstack
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jdeps
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jshell
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jimage
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jmap
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jarsigner
%attr(640, %{USER}, %{GROUP}) %{INSTALL_DIR}/jdk/bin/jar
