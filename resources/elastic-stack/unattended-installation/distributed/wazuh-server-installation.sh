...
installFilebeat() {
    ...
    then
        ...
        eval "curl -so /etc/filebeat/filebeat.yml https://raw.githubusercontent.com/wazuh/wazuh-packages/4.1/resources/elastic-stack/unattended-installation/distributed/templates/filebeat.yml --max-time 300  $debug"
