...
find <INSTALL_PATH> -group ossec -user root -exec chown root:wazuh {} \;
find <INSTALL_PATH> -group ossec -user ossec -exec chown wazuh:wazuh {} \;
find <INSTALL_PATH> -group ossec -user ossecm -exec chown wazuh:wazuh {} \;
find <INSTALL_PATH> -group ossec -user ossecr -exec chown wazuh:wazuh {} \;
