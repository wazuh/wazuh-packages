...
wia_apt_dependencies=( systemd grep tar coreutils sed procps gawk lsof curl openssl )
wazuh_yum_dependencies=( libcap gnupg2 )
wazuh_apt_dependencies=( apt-transport-https libcap2-bin software-properties-common gnupg )
