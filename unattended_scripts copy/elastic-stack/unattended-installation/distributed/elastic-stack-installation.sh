...
WAZUH_MAJOR="4.2"
<<<<<<< HEAD:unattended_scripts/elastic-stack/unattended-installation/distributed/elastic-stack-installation.sh
WAZUH_VER="4.2.5"
=======
WAZUH_VER="4.2.4"
>>>>>>> origin/unify-unattended:unattended_scripts copy/elastic-stack/unattended-installation/distributed/elastic-stack-installation.sh
WAZUH_REV="1"
ELK_VER="7.14.2"
