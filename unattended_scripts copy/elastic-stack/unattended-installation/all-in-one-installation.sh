...
<<<<<<< HEAD:unattended_scripts/elastic-stack/unattended-installation/all-in-one-installation.sh
WAZUH_VER="4.2.5"
=======
WAZUH_VER="4.2.4"
>>>>>>> origin/unify-unattended:unattended_scripts copy/elastic-stack/unattended-installation/all-in-one-installation.sh
WAZUH_REV="1"
ELK_VER="7.14.2"
