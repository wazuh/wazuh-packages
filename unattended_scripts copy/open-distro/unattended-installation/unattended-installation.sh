...
WAZUH_MAJOR="4.2"
<<<<<<< HEAD:unattended_scripts/open-distro/unattended-installation/unattended-installation.sh
WAZUH_VER="4.2.5"
=======
WAZUH_VER="4.2.4"
>>>>>>> origin/unify-unattended:unattended_scripts copy/open-distro/unattended-installation/unattended-installation.sh
WAZUH_REV="1"
ELK_VER="7.10.2"
OD_VER="1.13.2"
OD_REV="1"
